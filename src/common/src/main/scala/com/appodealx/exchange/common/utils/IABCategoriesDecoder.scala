...
object IABCategoriesDecoder {

  private val IABCategoriesMap = Map(
  ...
  def decode(IABId: String): String = {
    IABCategoriesMap.getOrElse(IABId.toUpperCase, "Unknown")
  }

  def exist(IABId: String): Boolean = {
    IABCategoriesMap.contains(IABId.toUpperCase())
  }
}